...
public class Driver_detail {
	...
	public Driver_detail(String c_id, String c_name, String c_birth, String c_tel, String rental_place1,
			String rental_place2, String rental_place3, String return_place1, String return_place2,
			String return_place3, String request) {
		super();
		this.c_id = c_id;
		this.c_name = c_name;
