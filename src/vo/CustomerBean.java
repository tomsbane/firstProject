...
public class CustomerBean {
	...
	public CustomerBean(String c_id, String c_grade, String c_password, String c_name, String c_gender, String c_birth,
			String c_email1, String c_email2, String c_tel, String c_joindate, int order_quantity, int order_money) {
		super();
		this.c_id = c_id;
