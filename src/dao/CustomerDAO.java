...
public class CustomerDAO {
		//멤버변수(전역변수 : 전체 메서드에서 사용 가능)
			...
			/*** 싱글톤 패턴 : CustomerDAO객체 단 1개만 생성**************************
			 * 이유? 외부 클래스에서 "처음 생성된 CustomerDAO객체를 공유해서 사용하도록 하기 위해" 
			 */
			private CustomerDAO(){}
			
			private static CustomerDAO customerDAO;
			//static이유? 객체를 생성하기 전에 이미 메모리에 올라간 getInstance()메서드를 통해서만CustomerDAO객체를 1개만 만들도록 하기 위해
